...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/style-contestPage.css">
	<!------------------PLUGINS------------------>
	<!-------BOOSTRAP------>
	...
	<title>Competitions and exhibitions</title>
</head>
<body>
			...
			<div class="container">
			  <!--filtering-->
				...
				<div class="grid">
			  	...
			  	<div class="contestTextDiv marginTextDiv">
			  		<h2>Konkurs 2</h2>
			  	</div>
				<div class="grid">
			    	<div class="grid-sizer col-xs-12 col-sm-6 col-md-4 col-lg-4"></div>
	...
	<script src='https://cdn.jsdelivr.net/prettyphoto/3.1.6/js/jquery.prettyPhoto.js'></script><script  src="js/script-contestPage.js"></script>
</body>
</html>